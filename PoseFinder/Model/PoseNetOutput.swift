...
extension PoseNetOutput {
    ...
    func position(for jointName: Joint.Name, at cell: Cell) -> CGPoint {
        ...
        //print("짜라란 \(jointPosition)")
        
        //print("joint index \(jointName.rawValue)")
        //print( jointName.rawValue, jointPosition)
    ...
    ///
    /// Queries the `offsets` array at position `[jointName, cell.yIndex, cell.xIndex]` for the component
    ///  and `[jointName + <number of joints>, cell.yIndex, cell.xIndex]` for the
